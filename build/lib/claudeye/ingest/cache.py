...
def _event_to_record(event: Event) -> dict[str, Any]:
    ...
    u uuid, m message_id, as attribution skill, md model, us usage
    4-tuple, ae api error, ra retry attempt, cb compact boundary,
    cp compact preTokens, tu tool_uses, tr tool_results, al agent link.
    """
